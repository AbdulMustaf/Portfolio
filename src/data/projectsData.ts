...
export const projectsData: Project[] = [
  ...
  },
  {
    id: 'medsafe-ai',
    title: 'MedSafe AI',
    subtitle: 'Hackathon-winning hospital violence detection system',
    description:
      'A real-time AI system that detects aggression in hospital settings from video and audio, and alerts security staff automatically. Built at HackHive.',
    longDescription:
      'MedSafe AI addresses workplace violence in healthcare, where roughly one in five workers experience physical violence or verbal abuse. The system combines computer vision and audio analysis to distinguish aggressive behaviour from normal activity in real time, then pushes automated alerts to security personnel through a monitoring dashboard. It is deliberately privacy-preserving — it classifies actions rather than identifying individuals, stores no personal identifiers, and encrypts data in transit — with bias mitigation and explainability treated as design requirements rather than afterthoughts.',
    tags: [
      'Python',
      'OpenCV',
      'TensorFlow',
